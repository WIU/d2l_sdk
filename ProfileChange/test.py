...
# factory functions
def fashion_app_context(app_id='ysuBVIqmRDaJpnVEOb8Ylg', app_key='t3Rro3P91i_U1let5vd8Wg'):
...
def fashion_user_context(app_id='ysuBVIqmRDaJpnVEOb8Ylg',
...
class D2LAppContext(object):
    ...
    def __init__(self, app_id='ysuBVIqmRDaJpnVEOb8Ylg', app_key='t3Rro3P91i_U1let5vd8Wg', signer=None):
    ...
    def create_user_context(self,
                            result_uri='',
                            host='wiutest.desire2learn.com/443',
...
class D2LUserContext(AuthBase):
    ...
    def __init__(self, host='wiutest.desire2learn.com/443', user_id='sJiaLZAl41bHfa_fnyfyAp', user_key='3MznLMWrEtGU0XJddnj15W', app_id='ysuBVIqmRDaJpnVEOb8Ylg', app_key='t3Rro3P91i_U1let5vd8Wg',
        ...
        if self.user_id == 'sJiaLZAl41bHfa_fnyfyAp':
            self.anonymous = True
        else:
    ...
    def create_authenticated_url(self,
        ...
        query = urllib.parse.urlencode(self._build_tokens_for_path(path,method=method),doseq=True)
